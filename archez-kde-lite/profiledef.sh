...
iso_publisher="ArchEZ <https://github.com/SuperSonic65535/archez-linux-archiso>"
iso_application="ArchEZ"
iso_version="kde-lite-$(date --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%Y.%m.%d)"
install_dir="arch"
buildmodes=('iso')
...
file_permissions=(
    ["/etc/dotfiles.d/live/Desktop/install-arch.desktop"]="0:0:755"
